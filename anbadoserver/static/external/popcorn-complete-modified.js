  ...
  Popcorn.player( "youtube", {
    ...
    _setup: function( options ) {
      ...
      var youtubeInit = function() {
        ...
        playerVars = { wmode: "transparent", rel: 0, controls: 0, showinfo:0, iv_load_policy:3 ,playsinline:1,autoplay:1}; // relative recommend off, control off, information off, annotation off, inline on
