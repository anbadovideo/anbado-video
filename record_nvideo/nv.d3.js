...
*/
  ...
  //------------------------------------------------------------
    ...
    lines.dispatch.on('elementClick.area', function(e) {
        ...
        console.log("kimmijong epos"+ e.pos[0]);
...
nv.models.stackedArea = function() {
  ...
  scatter.dispatch.on('elementMouseout.tooltip', function(e) {
////
//      e.pos = [CLIENTVAR.popcornobj.currentTime() + margin.left, 0 + margin.top],
//          dispatch.tooltipShow(e);
        dispatch.tooltipHide(e);
  });
  ...
  return chart;
    ...
    tooltiptime=function(){
       ...
       var time=CLIENTVAR.popcornobj.duration();
       time=parseInt(time);
       time=   ((parseInt($("#stackedarea").css("width"))-85)/time);
        ...
        nv.tooltip.cleanup();
        nv.tooltip.show([345+CLIENTVAR.popcornobj.currentTime()*time, 600], con, 'n', null, 0);//kimmijong 툴팁 시간별로 나타내기
  ...
  //============================================================
  // Private Variables    툴팁 상에서 표현 되는 텍스트에 대해 위치 및 들어가는 데이터 변형 할수 있음
  //------------------------------------------------------------
  ...
  var showTooltip = function(e, offsetElement) {
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        ...
        y=y-0.5; //
        x=parseInt(x/60)+":"+parseInt(x%60),  // kimmijong x값에 대하여 시간을 변형 할수 있다.
        content = tooltip(e.series.key, x, y, e, chart);
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      gEnter.append('g').attr('class', 'nv-x nv-axis');//x축 html 임   kimmijong
      gEnter.append('g').attr('class', 'nv-y nv-axis');
