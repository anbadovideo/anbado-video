...
var VideoObject = function(videoID, provider, providerVID, timelineWeight, option){ // DOM은 target DOM을 이야기하고, 옵션의 경우 사이즈, 화질, 이벤트 개수 등
    ...
    this.chartWeight = timelineWeight;
