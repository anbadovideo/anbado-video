...
nv.models.scatterPlusLineChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    ...
    var left = e.pos[0] + ( offsetElement.offsetLeft || 0 ),
        ...
        yVal = null;//yAxis.tickFormat()(scatter.y()(e.point, e.pointIndex)); //  y text 나오는 number

      if( tooltipX != null )
          nv.tooltip.show([leftX, topX], tooltipX(e.series.key, xVal, yVal, e, chart), 'n', 1, offsetElement, 'x-nvtooltip');
      // if( tooltipY != null )  // y축 tooltip 표현 하는 부분 
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      g.select('.nv-x.nv-axis')
         ...
         // yAxis   // y값 
         //  .scale(y)
         //  .ticks(0) //yAxis.ticks() ? yAxis.ticks() : availableHeight / 36 )
      ...
      function updateFisheye() {
        ...
        //y.distortion(fisheye).focus(mouse[1]); // magnify 이동 하는 위치 나타내는 함수 
      ...
      controls.dispatch.on('legendClick', function(d,i) {
        ...
        if (d.disabled) {
          ...
          y.distortion(fisheye).focus(0);// 변형뒤 이동하는위치 
